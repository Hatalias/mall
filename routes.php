...
use Hts\Mall\Classes\Feeds\GoogleMerchantFeed;
use Hts\Mall\Models\FeedSettings;

// Send virtual product files to the user's browser.
Route::get('/mall/download/{key}/{idx?}', '\Hts\Mall\Classes\Downloads\VirtualProductFileDownload@handle')
    ->middleware('web');
...
//
// @see \Hts\Mall\Classes\Payments\PaymentRedirector::handlePaymentResult
