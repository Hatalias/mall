...
namespace Hts\Mall\FormWidgets;

use Backend\Classes\FormWidgetBase;
use Hts\Mall\Models\Currency;
...
class Price extends FormWidgetBase
{
    ...
    public function init()
    {
        ...
        $this->addJs('/plugins/hts/mall/assets/pricewidget.js', 'Hts.Mall');
        $this->addCss('/plugins/hts/mall/assets/pricewidget.css', 'Hts.Mall');
    }
    ...
    public function getSaveValue($value)
    {
        ...
        if (! $values->has($this->defaultCurrency->id)) {
            throw new ValidationException([$this->valueFrom => trans('hts.mall::lang.common.price_missing')]);
        }
