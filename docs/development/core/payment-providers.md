...
To implement a `PaymentProvider` simply extend the abstract `Hts\Mall\Classes\Payments\PaymentProvider` class and
...
Check out [the payment providers that are shipped with the plugin](https://github.com/Hts-GmbH/oc-mall-plugin/tree/develop/classes/payments) for more information on how to use these 
methods.
...
use Hts\Mall\Models\PaymentGatewaySettings;
use Hts\Mall\Classes\Payments\PaymentResult;

class ExampleProvider extends \Hts\Mall\Classes\Payments\PaymentProvider
{
    /**
     * The order that is being paid.
     *
     * @var \Hts\Mall\Models\Order
     */
    public $order;
    /**
...
use Hts\Mall\Classes\Payments\PaymentGateway;
