...
namespace Hts\Mall\Tests\Models;

use DB;
use Hts\Mall\Classes\Exceptions\OutOfStockException;
use Hts\Mall\Models\Cart;
use Hts\Mall\Models\Customer;
...
class CartTest extends PluginTestCase
{
    ...
    {
        DB::table('hts_mall_shipping_methods')->truncate();
